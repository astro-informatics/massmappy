...
k_rec_mw = mm.reduced_shear_to_kappa_mw(shear, L, Method=Method, tol_error=1E-1)
...
# 		plot_titles, save_figs, "fig/low_res_input_kappa_"+Projection+".png", color_range=kappa_plot_range)

# 	plot_projection(kappa_plane.real, mask, "kappa plane real "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_real.png", color_range=kappa_plot_range)
# 	plot_projection(kappa_plane.imag, mask, "kappa plane imag "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_imag.png", color_range=kappa_plot_range)

# 	plot_projection(kappa_plane.real-kappa_orig, mask, "kappa plane error real "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_error_real.png", smooth=smooth, color_range=kappa_plot_range)
# 	plot_projection(kappa_plane.imag, mask, "kappa plane error imag "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_error_imag.png", smooth=smooth, color_range=kappa_plot_range)

# 	plot_projection(gamma_plane.real, mask_real, "gamma plane real "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_gamma_"+Projection+"_real.png", color_range=gamma_plot_range)
# 	plot_projection(gamma_plane.imag, mask_imag, "gamma plane imag "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_gamma_"+Projection+"_imag.png", color_range=gamma_plot_range)
...
kappa_plane  = mm.reduced_shear_to_kappa_plane(shear_plane, np.pi/L, 2*np.pi/(2*L-1))
...
plt.ylabel(r"$\theta$")
if save_figs:
	plt.savefig("fig/low_res_input_kappa_cylindrical.png")
...
plt.ylabel(r"$\theta$")
if save_figs:
	plt.savefig("fig/low_res_kappa_cylindrical_real.png")
...
plt.ylabel(r"$\theta$")
if save_figs:
	plt.savefig("fig/low_res_kappa_Cylindrical_north_error_real.png")
...
plt.ylabel(r"$\theta$")
if save_figs:
	plt.savefig("fig/low_res_kappa_Cylindrical_north_error_imag.png")
...
# plt.ylabel(r"$\theta$")
# if save_figs:
# 	plt.savefig("fig/low_res_gamma_Cylindrical_imag.png")
...
# plt.ylabel(r"$\theta$")
# if save_figs:
# 	plt.savefig("fig/low_res_gamma_Cylindrical_real.png")
...
# 		plot_titles, save_figs, "fig/low_res_input_kappa_"+Projection+"_north.png", color_range=kappa_plot_range)
# 	plot_projection(kappa_orig_south.real, mask_north_real, "Input kappa plane south "+Projection, \
# 		plot_titles, save_figs, "fig/low_res_input_kappa_"+Projection+"_south.png", color_range=kappa_plot_range)

# 	plot_projection(kappa_plane_north.real, mask_north_real, "kappa plane north real "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_north_real.png", color_range=kappa_plot_range)

# 	plot_projection(kappa_plane_north.real-kappa_orig_north, mask_north_real, "kappa plane north error real "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_north_error_real.png", smooth=smooth, color_range=kappa_plot_range)
# 	plot_projection(kappa_plane_north.imag, mask_north_imag, "kappa plane north error imag "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_north_error_imag.png", smooth=smooth, color_range=kappa_plot_range)

# 	plot_projection(kappa_plane_south.real, mask_north_real, "kappa plane south real "+Projection, \
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_south_real.png", color_range=kappa_plot_range)

# 	plot_projection(kappa_plane_south.real-kappa_orig_south, mask_north_real, "kappa plane south error real "+Projection, \
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_south_error_real.png", smooth=smooth, color_range=kappa_plot_range)
# 	plot_projection(kappa_plane_south.imag, mask_north_imag, "kappa plane south error imag "+Projection, \
# 		plot_titles, save_figs, "fig/low_res_kappa_"+Projection+"_south_error_imag.png", smooth=smooth, color_range=kappa_plot_range)

# 	plot_projection(gamma_plane_north.real, mask_north_real, "gamma plane north real "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_gamma_"+Projection+"_north_real.png", color_range=gamma_plot_range)
# 	plot_projection(gamma_plane_north.imag, mask_north_imag, "gamma plane north imag "+Projection,\
# 		plot_titles, save_figs, "fig/low_res_gamma_"+Projection+"_north_imag.png", color_range=gamma_plot_range)

# 	plot_projection(gamma_plane_south.real, mask_north_real, "gamma plane south real "+Projection, \
# 		plot_titles, save_figs, "fig/low_res_gamma_"+Projection+"_south_real.png", color_range=gamma_plot_range)
# 	plot_projection(gamma_plane_south.imag, mask_north_imag, "gamma plane south imag "+Projection, \
# 		plot_titles, save_figs, "fig/low_res_gamma_"+Projection+"_south_imag.png", color_range=gamma_plot_range)

#	rotation_angle_north, rotation_angle_south = ssht.projection_rotation_array(orth_resolution, Projection=Projection, rot=[0.0,np.pi/2,0.0])
